...
def test_isPrime():
    ...
    assert isPrime(9) == True  # Este es el caso donde fallara, ya que 9 no es primo y en este caso esta dando que es primo el 9. 
...
def test_isPrime2():
    ...
    assert isPrime2(9) == False  # Este test ahora pasara correctamente, ya que 9 no es primo
